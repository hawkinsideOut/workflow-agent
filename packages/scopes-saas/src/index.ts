...
export const scopes: Scope[] = [
  ...
  {
    name: 'boards',
    description: 'Kanban boards, columns, board views, drag-and-drop functionality',
    emoji: '📋',
    category: 'features',
  },
  {
...
export const preset = {
  ...
  description: 'Comprehensive scope configuration for SaaS applications with user management, project features, and infrastructure',
  scopes,
  version: '1.0.0',
};
